...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://m.me/junaeid.ahmed.944"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/junaeid.ahmed.944")
...
\033[0;95m
\033[0;96m
 > \033[0;92mDEVELOPER     : JUNAEID AHEMD
 > \033[0;95mFACEBOOK ID   : JUNAEID AHMED
 > \033[0;41mWHATSAPP      : 01787936099
 \033[0;96m> YOUTUBE       : NOT FOUND
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[JXJ-CP😭] %s|%s\033[0;97m         "%(uid, pw))
